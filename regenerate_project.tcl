...
#
# regenerate_project.tcl: Tcl script for re-creating project 'microblaze_test_project'
#
...
#
#    "block_designs/test_blockdesign/test_blockdesign.bd"
#    "hdl/test_blockdesign_wrapper.vhd"
#
#*****************************************************************************************
...
set orig_proj_dir "[file normalize "$origin_dir/microblaze_test_project"]"

# Create project
create_project microblaze_test_project ./microblaze_test_project -part xc7k325tffg900-2
...
set obj [get_projects microblaze_test_project]
set_property "board_part" "xilinx.com:kc705:part0:1.3" $obj
set_property "compxlib.activehdl_compiled_library_dir" "$proj_dir/microblaze_test_project.cache/compile_simlib/activehdl" $obj
set_property "compxlib.funcsim" "1" $obj
set_property "compxlib.ies_compiled_library_dir" "$proj_dir/microblaze_test_project.cache/compile_simlib/ies" $obj
set_property "compxlib.modelsim_compiled_library_dir" "$proj_dir/microblaze_test_project.cache/compile_simlib/modelsim" $obj
set_property "compxlib.overwrite_libs" "0" $obj
set_property "compxlib.questa_compiled_library_dir" "$proj_dir/microblaze_test_project.cache/compile_simlib/questa" $obj
set_property "compxlib.riviera_compiled_library_dir" "$proj_dir/microblaze_test_project.cache/compile_simlib/riviera" $obj
set_property "compxlib.timesim" "1" $obj
set_property "compxlib.vcs_compiled_library_dir" "$proj_dir/microblaze_test_project.cache/compile_simlib/vcs" $obj
...
set files [list \
 "[file normalize "$origin_dir/block_designs/test_blockdesign/test_blockdesign.bd"]"\
 "[file normalize "$origin_dir/hdl/test_blockdesign_wrapper.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/block_designs/test_blockdesign/test_blockdesign.bd"
...
set file "$origin_dir/hdl/test_blockdesign_wrapper.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set_property "top" "test_blockdesign_wrapper" $obj
...
puts "INFO: Project created:microblaze_test_project"
